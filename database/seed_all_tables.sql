...
VALUES 
  ...
  ('00000003-0000-0000-0000-00000000000a', '00000001-0000-0000-0000-000000000001', 'ananya.sharma1@dps.edu', '$2b$10$MYGc0dD.qTR.q2jk8.vgNecKebRnLacNVTu//wJkKBUK3xPOtPxfa', 'student', 'Ananya', 'अनन्या', 'Sharma', 'शर्मा', NULL, 'ADM-2025-001', 'STU-2025-001', 'female', true, NOW(), NOW()),
  ('00000003-0000-0000-0000-00000000000b', '00000001-0000-0000-0000-000000000001', 'diya.patel2@dps.edu', '$2b$10$MYGc0dD.qTR.q2jk8.vgNecKebRnLacNVTu//wJkKBUK3xPOtPxfa', 'student', 'Diya', 'दिया', 'Patel', 'पटेल', NULL, 'ADM-2025-002', 'STU-2025-002', 'female', true, NOW(), NOW()),
  ('00000003-0000-0000-0000-00000000000c', '00000001-0000-0000-0000-000000000001', 'ishita.gupta3@dps.edu', '$2b$10$MYGc0dD.qTR.q2jk8.vgNecKebRnLacNVTu//wJkKBUK3xPOtPxfa', 'student', 'Ishita', 'इशिता', 'Gupta', 'गुप्ता', NULL, 'ADM-2025-003', 'STU-2025-003', 'female', true, NOW(), NOW()),
  ('00000003-0000-0000-0000-00000000000d', '00000001-0000-0000-0000-000000000001', 'riya.singh4@dps.edu', '$2b$10$MYGc0dD.qTR.q2jk8.vgNecKebRnLacNVTu//wJkKBUK3xPOtPxfa', 'student', 'Riya', 'रिया', 'Singh', 'सिंह', NULL, 'ADM-2025-004', 'STU-2025-004', 'female', true, NOW(), NOW()),
  ('00000003-0000-0000-0000-00000000000e', '00000001-0000-0000-0000-000000000001', 'sneha.reddy5@dps.edu', '$2b$10$MYGc0dD.qTR.q2jk8.vgNecKebRnLacNVTu//wJkKBUK3xPOtPxfa', 'student', 'Sneha', 'स्नेहा', 'Reddy', 'रेड्डी', NULL, 'ADM-2025-005', 'STU-2025-005', 'female', true, NOW(), NOW()),
  ('00000003-0000-0000-0000-00000000000f', '00000001-0000-0000-0000-000000000001', 'pooja.verma6@dps.edu', '$2b$10$MYGc0dD.qTR.q2jk8.vgNecKebRnLacNVTu//wJkKBUK3xPOtPxfa', 'student', 'Pooja', 'पूजा', 'Verma', 'वर्मा', NULL, 'ADM-2025-006', 'STU-2025-006', 'female', true, NOW(), NOW()),
  ('00000003-0000-0000-0000-000000000010', '00000001-0000-0000-0000-000000000001', 'simran.kaur7@dps.edu', '$2b$10$MYGc0dD.qTR.q2jk8.vgNecKebRnLacNVTu//wJkKBUK3xPOtPxfa', 'student', 'Simran', 'सिमरन', 'Kaur', 'कौर', NULL, 'ADM-2025-007', 'STU-2025-007', 'female', true, NOW(), NOW()),
  ('00000003-0000-0000-0000-000000000011', '00000001-0000-0000-0000-000000000001', 'tanvi.joshi8@dps.edu', '$2b$10$MYGc0dD.qTR.q2jk8.vgNecKebRnLacNVTu//wJkKBUK3xPOtPxfa', 'student', 'Tanvi', 'तन्वी', 'Joshi', 'जोशी', NULL, 'ADM-2025-008', 'STU-2025-008', 'female', true, NOW(), NOW()),
  ('00000003-0000-0000-0000-000000000012', '00000001-0000-0000-0000-000000000001', 'kavya.nair9@dps.edu', '$2b$10$MYGc0dD.qTR.q2jk8.vgNecKebRnLacNVTu//wJkKBUK3xPOtPxfa', 'student', 'Kavya', 'काव्या', 'Nair', 'नायर', NULL, 'ADM-2025-009', 'STU-2025-009', 'female', true, NOW(), NOW()),
  ('00000003-0000-0000-0000-000000000013', '00000001-0000-0000-0000-000000000001', 'meera.iyer10@dps.edu', '$2b$10$MYGc0dD.qTR.q2jk8.vgNecKebRnLacNVTu//wJkKBUK3xPOtPxfa', 'student', 'Meera', 'मीरा', 'Iyer', 'अय्यर', NULL, 'ADM-2025-010', 'STU-2025-010', 'female', true, NOW(), NOW()),
  ('00000003-0000-0000-0000-000000000014', '00000001-0000-0000-0000-000000000001', 'shreya.sen11@dps.edu', '$2b$10$MYGc0dD.qTR.q2jk8.vgNecKebRnLacNVTu//wJkKBUK3xPOtPxfa', 'student', 'Shreya', 'श्रेया', 'Sen', 'सेन', NULL, 'ADM-2025-011', 'STU-2025-011', 'female', true, NOW(), NOW()),
  ('00000003-0000-0000-0000-000000000015', '00000001-0000-0000-0000-000000000001', 'neha.bhatia12@dps.edu', '$2b$10$MYGc0dD.qTR.q2jk8.vgNecKebRnLacNVTu//wJkKBUK3xPOtPxfa', 'student', 'Neha', 'नेहा', 'Bhatia', 'भाटिया', NULL, 'ADM-2025-012', 'STU-2025-012', 'female', true, NOW(), NOW()),
  ('00000003-0000-0000-0000-000000000016', '00000001-0000-0000-0000-000000000001', 'aditi.rao13@dps.edu', '$2b$10$MYGc0dD.qTR.q2jk8.vgNecKebRnLacNVTu//wJkKBUK3xPOtPxfa', 'student', 'Aditi', 'अदिति', 'Rao', 'राव', NULL, 'ADM-2025-013', 'STU-2025-013', 'female', true, NOW(), NOW()),
  ('00000003-0000-0000-0000-000000000017', '00000001-0000-0000-0000-000000000001', 'priyanka.das14@dps.edu', '$2b$10$MYGc0dD.qTR.q2jk8.vgNecKebRnLacNVTu//wJkKBUK3xPOtPxfa', 'student', 'Priyanka', 'प्रियंका', 'Das', 'दास', NULL, 'ADM-2025-014', 'STU-2025-014', 'female', true, NOW(), NOW()),
  ('00000003-0000-0000-0000-000000000018', '00000001-0000-0000-0000-000000000001', 'khushi.mehta15@dps.edu', '$2b$10$MYGc0dD.qTR.q2jk8.vgNecKebRnLacNVTu//wJkKBUK3xPOtPxfa', 'student', 'Khushi', 'खुशी', 'Mehta', 'मेहता', NULL, 'ADM-2025-015', 'STU-2025-015', 'female', true, NOW(), NOW()),
  ('00000003-0000-0000-0000-000000000019', '00000001-0000-0000-0000-000000000001', 'roshni.saxena16@dps.edu', '$2b$10$MYGc0dD.qTR.q2jk8.vgNecKebRnLacNVTu//wJkKBUK3xPOtPxfa', 'student', 'Roshni', 'रोशनी', 'Saxena', 'सक्सेना', NULL, 'ADM-2025-016', 'STU-2025-016', 'female', true, NOW(), NOW()),
  ('00000003-0000-0000-0000-00000000001a', '00000001-0000-0000-0000-000000000001', 'navya.choudhary17@dps.edu', '$2b$10$MYGc0dD.qTR.q2jk8.vgNecKebRnLacNVTu//wJkKBUK3xPOtPxfa', 'student', 'Navya', 'नव्या', 'Choudhary', 'चौधरी', NULL, 'ADM-2025-017', 'STU-2025-017', 'female', true, NOW(), NOW()),
  ('00000003-0000-0000-0000-00000000001b', '00000001-0000-0000-0000-000000000001', 'mansi.agarwal18@dps.edu', '$2b$10$MYGc0dD.qTR.q2jk8.vgNecKebRnLacNVTu//wJkKBUK3xPOtPxfa', 'student', 'Mansi', 'मानसी', 'Agarwal', 'अग्रवाल', NULL, 'ADM-2025-018', 'STU-2025-018', 'female', true, NOW(), NOW()),
  ('00000003-0000-0000-0000-00000000001c', '00000001-0000-0000-0000-000000000001', 'jaspreet.kaur19@dps.edu', '$2b$10$MYGc0dD.qTR.q2jk8.vgNecKebRnLacNVTu//wJkKBUK3xPOtPxfa', 'student', 'Jaspreet', 'जसप्रीत', 'Kaur', 'कौर', NULL, 'ADM-2025-019', 'STU-2025-019', 'female', true, NOW(), NOW()),
  ('00000003-0000-0000-0000-00000000001d', '00000001-0000-0000-0000-000000000001', 'harleen.kaur20@dps.edu', '$2b$10$MYGc0dD.qTR.q2jk8.vgNecKebRnLacNVTu//wJkKBUK3xPOtPxfa', 'student', 'Harleen', 'हरलीन', 'Kaur', 'कौर', NULL, 'ADM-2025-020', 'STU-2025-020', 'female', true, NOW(), NOW()),
  ('00000003-0000-0000-0000-00000000001e', '00000001-0000-0000-0000-000000000001', 'avani.deshmukh21@dps.edu', '$2b$10$MYGc0dD.qTR.q2jk8.vgNecKebRnLacNVTu//wJkKBUK3xPOtPxfa', 'student', 'Avani', 'अवनी', 'Deshmukh', 'देशमुख', NULL, 'ADM-2025-021', 'STU-2025-021', 'female', true, NOW(), NOW()),
  ('00000003-0000-0000-0000-00000000001f', '00000001-0000-0000-0000-000000000001', 'bhavya.trivedi22@dps.edu', '$2b$10$MYGc0dD.qTR.q2jk8.vgNecKebRnLacNVTu//wJkKBUK3xPOtPxfa', 'student', 'Bhavya', 'भव्या', 'Trivedi', 'त्रिवेदी', NULL, 'ADM-2025-022', 'STU-2025-022', 'female', true, NOW(), NOW()),
  ('00000003-0000-0000-0000-000000000020', '00000001-0000-0000-0000-000000000001', 'chhavi.singhania23@dps.edu', '$2b$10$MYGc0dD.qTR.q2jk8.vgNecKebRnLacNVTu//wJkKBUK3xPOtPxfa', 'student', 'Chhavi', 'छवि', 'Singhania', 'सिंघानिया', NULL, 'ADM-2025-023', 'STU-2025-023', 'female', true, NOW(), NOW()),
  ('00000003-0000-0000-0000-000000000021', '00000001-0000-0000-0000-000000000001', 'drishti.malhotra24@dps.edu', '$2b$10$MYGc0dD.qTR.q2jk8.vgNecKebRnLacNVTu//wJkKBUK3xPOtPxfa', 'student', 'Drishti', 'दृष्टि', 'Malhotra', 'मल्होत्रा', NULL, 'ADM-2025-024', 'STU-2025-024', 'female', true, NOW(), NOW()),
  ('00000003-0000-0000-0000-000000000022', '00000001-0000-0000-0000-000000000001', 'esha.pillai25@dps.edu', '$2b$10$MYGc0dD.qTR.q2jk8.vgNecKebRnLacNVTu//wJkKBUK3xPOtPxfa', 'student', 'Esha', 'ईशा', 'Pillai', 'पिल्लई', NULL, 'ADM-2025-025', 'STU-2025-025', 'female', true, NOW(), NOW()),
  ('00000003-0000-0000-0000-000000000023', '00000001-0000-0000-0000-000000000001', 'gargi.mukherjee26@dps.edu', '$2b$10$MYGc0dD.qTR.q2jk8.vgNecKebRnLacNVTu//wJkKBUK3xPOtPxfa', 'student', 'Gargi', 'गार्गी', 'Mukherjee', 'मुखर्जी', NULL, 'ADM-2025-026', 'STU-2025-026', 'female', true, NOW(), NOW()),
  ('00000003-0000-0000-0000-000000000024', '00000001-0000-0000-0000-000000000001', 'ishani.banerjee27@dps.edu', '$2b$10$MYGc0dD.qTR.q2jk8.vgNecKebRnLacNVTu//wJkKBUK3xPOtPxfa', 'student', 'Ishani', 'ईशानी', 'Banerjee', 'बनर्जी', NULL, 'ADM-2025-027', 'STU-2025-027', 'female', true, NOW(), NOW()),
  ('00000003-0000-0000-0000-000000000025', '00000001-0000-0000-0000-000000000001', 'jiya.kulkarni28@dps.edu', '$2b$10$MYGc0dD.qTR.q2jk8.vgNecKebRnLacNVTu//wJkKBUK3xPOtPxfa', 'student', 'Jiya', 'जिया', 'Kulkarni', 'कुलकर्णी', NULL, 'ADM-2025-028', 'STU-2025-028', 'female', true, NOW(), NOW()),
  ('00000003-0000-0000-0000-000000000026', '00000001-0000-0000-0000-000000000001', 'kriti.menon29@dps.edu', '$2b$10$MYGc0dD.qTR.q2jk8.vgNecKebRnLacNVTu//wJkKBUK3xPOtPxfa', 'student', 'Kriti', 'कृति', 'Menon', 'मेनन', NULL, 'ADM-2025-029', 'STU-2025-029', 'female', true, NOW(), NOW()),
  ('00000003-0000-0000-0000-000000000027', '00000001-0000-0000-0000-000000000001', 'lavanya.jain30@dps.edu', '$2b$10$MYGc0dD.qTR.q2jk8.vgNecKebRnLacNVTu//wJkKBUK3xPOtPxfa', 'student', 'Lavanya', 'लावण्या', 'Jain', 'जैन', NULL, 'ADM-2025-030', 'STU-2025-030', 'female', true, NOW(), NOW()),
  ('00000003-0000-0000-0000-000000000028', '00000001-0000-0000-0000-000000000001', 'nandini.mittal31@dps.edu', '$2b$10$MYGc0dD.qTR.q2jk8.vgNecKebRnLacNVTu//wJkKBUK3xPOtPxfa', 'student', 'Nandini', 'नंदिनी', 'Mittal', 'मित्तल', NULL, 'ADM-2025-031', 'STU-2025-031', 'female', true, NOW(), NOW()),
  ('00000003-0000-0000-0000-000000000029', '00000001-0000-0000-0000-000000000001', 'pallavi.sethi32@dps.edu', '$2b$10$MYGc0dD.qTR.q2jk8.vgNecKebRnLacNVTu//wJkKBUK3xPOtPxfa', 'student', 'Pallavi', 'पल्लवी', 'Sethi', 'सेठी', NULL, 'ADM-2025-032', 'STU-2025-032', 'female', true, NOW(), NOW()),
  ('00000003-0000-0000-0000-00000000002a', '00000001-0000-0000-0000-000000000001', 'aarav.sharma33@dps.edu', '$2b$10$MYGc0dD.qTR.q2jk8.vgNecKebRnLacNVTu//wJkKBUK3xPOtPxfa', 'student', 'Aarav', 'आरव', 'Sharma', 'शर्मा', NULL, 'ADM-2025-033', 'STU-2025-033', 'male', true, NOW(), NOW()),
  ('00000003-0000-0000-0000-00000000002b', '00000001-0000-0000-0000-000000000001', 'rohan.verma34@dps.edu', '$2b$10$MYGc0dD.qTR.q2jk8.vgNecKebRnLacNVTu//wJkKBUK3xPOtPxfa', 'student', 'Rohan', 'रोहन', 'Verma', 'वर्मा', NULL, 'ADM-2025-034', 'STU-2025-034', 'male', true, NOW(), NOW()),
  ('00000003-0000-0000-0000-00000000002c', '00000001-0000-0000-0000-000000000001', 'kabir.mehta35@dps.edu', '$2b$10$MYGc0dD.qTR.q2jk8.vgNecKebRnLacNVTu//wJkKBUK3xPOtPxfa', 'student', 'Kabir', 'कबीर', 'Mehta', 'मेहता', NULL, 'ADM-2025-035', 'STU-2025-035', 'male', true, NOW(), NOW()),
  ('00000003-0000-0000-0000-00000000002d', '00000001-0000-0000-0000-000000000001', 'vikram.malhotra36@dps.edu', '$2b$10$MYGc0dD.qTR.q2jk8.vgNecKebRnLacNVTu//wJkKBUK3xPOtPxfa', 'student', 'Vikram', 'विक्रम', 'Malhotra', 'मल्होत्रा', NULL, 'ADM-2025-036', 'STU-2025-036', 'male', true, NOW(), NOW()),
  ('00000003-0000-0000-0000-00000000002e', '00000001-0000-0000-0000-000000000001', 'aditya.singh37@dps.edu', '$2b$10$MYGc0dD.qTR.q2jk8.vgNecKebRnLacNVTu//wJkKBUK3xPOtPxfa', 'student', 'Aditya', 'आदित्य', 'Singh', 'सिंह', NULL, 'ADM-2025-037', 'STU-2025-037', 'male', true, NOW(), NOW()),
  ('00000003-0000-0000-0000-00000000002f', '00000001-0000-0000-0000-000000000001', 'manpreet.singh38@dps.edu', '$2b$10$MYGc0dD.qTR.q2jk8.vgNecKebRnLacNVTu//wJkKBUK3xPOtPxfa', 'student', 'Manpreet', 'मनप्रीत', 'Singh', 'सिंह', NULL, 'ADM-2025-038', 'STU-2025-038', 'male', true, NOW(), NOW()),
  ('00000003-0000-0000-0000-000000000030', '00000001-0000-0000-0000-000000000001', 'gurpreet.singh39@dps.edu', '$2b$10$MYGc0dD.qTR.q2jk8.vgNecKebRnLacNVTu//wJkKBUK3xPOtPxfa', 'student', 'Gurpreet', 'गुरप्रीत', 'Singh', 'सिंह', NULL, 'ADM-2025-039', 'STU-2025-039', 'male', true, NOW(), NOW()),
  ('00000003-0000-0000-0000-000000000031', '00000001-0000-0000-0000-000000000001', 'aryan.kapoor40@dps.edu', '$2b$10$MYGc0dD.qTR.q2jk8.vgNecKebRnLacNVTu//wJkKBUK3xPOtPxfa', 'student', 'Aryan', 'आर्यन', 'Kapoor', 'कपूर', NULL, 'ADM-2025-040', 'STU-2025-040', 'male', true, NOW(), NOW()),
  ('00000003-0000-0000-0000-000000000032', '00000001-0000-0000-0000-000000000001', 'karan.johar41@dps.edu', '$2b$10$MYGc0dD.qTR.q2jk8.vgNecKebRnLacNVTu//wJkKBUK3xPOtPxfa', 'student', 'Karan', 'करण', 'Johar', 'जौहर', NULL, 'ADM-2025-041', 'STU-2025-041', 'male', true, NOW(), NOW()),
  ('00000003-0000-0000-0000-000000000033', '00000001-0000-0000-0000-000000000001', 'yash.khanna42@dps.edu', '$2b$10$MYGc0dD.qTR.q2jk8.vgNecKebRnLacNVTu//wJkKBUK3xPOtPxfa', 'student', 'Yash', 'यश', 'Khanna', 'खन्ना', NULL, 'ADM-2025-042', 'STU-2025-042', 'male', true, NOW(), NOW()),
  ('00000003-0000-0000-0000-000000000034', '00000001-0000-0000-0000-000000000001', 'rahul.gupta43@dps.edu', '$2b$10$MYGc0dD.qTR.q2jk8.vgNecKebRnLacNVTu//wJkKBUK3xPOtPxfa', 'student', 'Rahul', 'राहुल', 'Gupta', 'गुप्ता', NULL, 'ADM-2025-043', 'STU-2025-043', 'male', true, NOW(), NOW()),
  ('00000003-0000-0000-0000-000000000035', '00000001-0000-0000-0000-000000000001', 'arjun.nair44@dps.edu', '$2b$10$MYGc0dD.qTR.q2jk8.vgNecKebRnLacNVTu//wJkKBUK3xPOtPxfa', 'student', 'Arjun', 'अर्जुन', 'Nair', 'नायर', NULL, 'ADM-2025-044', 'STU-2025-044', 'male', true, NOW(), NOW()),
  ('00000003-0000-0000-0000-000000000036', '00000001-0000-0000-0000-000000000001', 'dev.patel45@dps.edu', '$2b$10$MYGc0dD.qTR.q2jk8.vgNecKebRnLacNVTu//wJkKBUK3xPOtPxfa', 'student', 'Dev', 'देव', 'Patel', 'पटेल', NULL, 'ADM-2025-045', 'STU-2025-045', 'male', true, NOW(), NOW()),
  ('00000003-0000-0000-0000-000000000037', '00000001-0000-0000-0000-000000000001', 'kunal.bhatia46@dps.edu', '$2b$10$MYGc0dD.qTR.q2jk8.vgNecKebRnLacNVTu//wJkKBUK3xPOtPxfa', 'student', 'Kunal', 'कुणाल', 'Bhatia', 'भाटिया', NULL, 'ADM-2025-046', 'STU-2025-046', 'male', true, NOW(), NOW()),
  ('00000003-0000-0000-0000-000000000038', '00000001-0000-0000-0000-000000000001', 'sahil.sethi47@dps.edu', '$2b$10$MYGc0dD.qTR.q2jk8.vgNecKebRnLacNVTu//wJkKBUK3xPOtPxfa', 'student', 'Sahil', 'साहिल', 'Sethi', 'सेठी', NULL, 'ADM-2025-047', 'STU-2025-047', 'male', true, NOW(), NOW()),
  ('00000003-0000-0000-0000-000000000039', '00000001-0000-0000-0000-000000000001', 'pranav.joshi48@dps.edu', '$2b$10$MYGc0dD.qTR.q2jk8.vgNecKebRnLacNVTu//wJkKBUK3xPOtPxfa', 'student', 'Pranav', 'प्रणव', 'Joshi', 'जोशी', NULL, 'ADM-2025-048', 'STU-2025-048', 'male', true, NOW(), NOW()),
  ('00000003-0000-0000-0000-00000000003a', '00000001-0000-0000-0000-000000000001', 'varun.dhawan49@dps.edu', '$2b$10$MYGc0dD.qTR.q2jk8.vgNecKebRnLacNVTu//wJkKBUK3xPOtPxfa', 'student', 'Varun', 'वरुण', 'Dhawan', 'धवन', NULL, 'ADM-2025-049', 'STU-2025-049', 'male', true, NOW(), NOW()),
  ('00000003-0000-0000-0000-00000000003b', '00000001-0000-0000-0000-000000000001', 'siddharth.roy50@dps.edu', '$2b$10$MYGc0dD.qTR.q2jk8.vgNecKebRnLacNVTu//wJkKBUK3xPOtPxfa', 'student', 'Siddharth', 'सिद्धार्थ', 'Roy', 'रॉय', NULL, 'ADM-2025-050', 'STU-2025-050', 'male', true, NOW(), NOW()),
  ('00000003-0000-0000-0000-00000000003c', '00000001-0000-0000-0000-000000000001', 'harshit.bansal51@dps.edu', '$2b$10$MYGc0dD.qTR.q2jk8.vgNecKebRnLacNVTu//wJkKBUK3xPOtPxfa', 'student', 'Harshit', 'हर्षित', 'Bansal', 'बंसल', NULL, 'ADM-2025-051', 'STU-2025-051', 'male', true, NOW(), NOW()),
  ('00000003-0000-0000-0000-00000000003d', '00000001-0000-0000-0000-000000000001', 'ritvik.soni52@dps.edu', '$2b$10$MYGc0dD.qTR.q2jk8.vgNecKebRnLacNVTu//wJkKBUK3xPOtPxfa', 'student', 'Ritvik', 'ऋत्विक', 'Soni', 'सोनी', NULL, 'ADM-2025-052', 'STU-2025-052', 'male', true, NOW(), NOW())
ON CONFLICT (id) DO NOTHING;
...
VALUES 
  ...
  ('00000008-0000-0000-0000-000000000004', '00000003-0000-0000-0000-00000000000b', '00000007-0000-0000-0000-000000000005', 1, CURRENT_DATE, 'active'),
  ('00000008-0000-0000-0000-000000000005', '00000003-0000-0000-0000-00000000000c', '00000007-0000-0000-0000-000000000007', 1, CURRENT_DATE, 'active'),
  ('00000008-0000-0000-0000-000000000006', '00000003-0000-0000-0000-00000000000d', '00000007-0000-0000-0000-000000000008', 1, CURRENT_DATE, 'active'),
  ('00000008-0000-0000-0000-000000000007', '00000003-0000-0000-0000-00000000000e', '00000007-0000-0000-0000-000000000006', 1, CURRENT_DATE, 'active'),
  ('00000008-0000-0000-0000-000000000008', '00000003-0000-0000-0000-00000000000f', '00000007-0000-0000-0000-000000000009', 1, CURRENT_DATE, 'active'),
  ('00000008-0000-0000-0000-000000000009', '00000003-0000-0000-0000-000000000010', '00000007-0000-0000-0000-000000000004', 2, CURRENT_DATE, 'active'),
  ('00000008-0000-0000-0000-00000000000a', '00000003-0000-0000-0000-000000000011', '00000007-0000-0000-0000-000000000005', 2, CURRENT_DATE, 'active'),
  ('00000008-0000-0000-0000-00000000000b', '00000003-0000-0000-0000-000000000012', '00000007-0000-0000-0000-000000000007', 2, CURRENT_DATE, 'active'),
  ('00000008-0000-0000-0000-00000000000c', '00000003-0000-0000-0000-000000000013', '00000007-0000-0000-0000-000000000008', 2, CURRENT_DATE, 'active'),
  ('00000008-0000-0000-0000-00000000000d', '00000003-0000-0000-0000-000000000014', '00000007-0000-0000-0000-000000000006', 2, CURRENT_DATE, 'active'),
  ('00000008-0000-0000-0000-00000000000e', '00000003-0000-0000-0000-000000000015', '00000007-0000-0000-0000-000000000009', 2, CURRENT_DATE, 'active'),
  ('00000008-0000-0000-0000-00000000000f', '00000003-0000-0000-0000-000000000016', '00000007-0000-0000-0000-000000000004', 3, CURRENT_DATE, 'active'),
  ('00000008-0000-0000-0000-000000000010', '00000003-0000-0000-0000-000000000017', '00000007-0000-0000-0000-000000000005', 3, CURRENT_DATE, 'active'),
  ('00000008-0000-0000-0000-000000000011', '00000003-0000-0000-0000-000000000018', '00000007-0000-0000-0000-000000000007', 3, CURRENT_DATE, 'active'),
  ('00000008-0000-0000-0000-000000000012', '00000003-0000-0000-0000-000000000019', '00000007-0000-0000-0000-000000000008', 3, CURRENT_DATE, 'active'),
  ('00000008-0000-0000-0000-000000000013', '00000003-0000-0000-0000-00000000001a', '00000007-0000-0000-0000-000000000006', 3, CURRENT_DATE, 'active'),
  ('00000008-0000-0000-0000-000000000014', '00000003-0000-0000-0000-00000000001b', '00000007-0000-0000-0000-000000000009', 3, CURRENT_DATE, 'active'),
  ('00000008-0000-0000-0000-000000000015', '00000003-0000-0000-0000-00000000001c', '00000007-0000-0000-0000-000000000004', 4, CURRENT_DATE, 'active'),
  ('00000008-0000-0000-0000-000000000016', '00000003-0000-0000-0000-00000000001d', '00000007-0000-0000-0000-000000000005', 4, CURRENT_DATE, 'active'),
  ('00000008-0000-0000-0000-000000000017', '00000003-0000-0000-0000-00000000001e', '00000007-0000-0000-0000-000000000007', 4, CURRENT_DATE, 'active'),
  ('00000008-0000-0000-0000-000000000018', '00000003-0000-0000-0000-00000000001f', '00000007-0000-0000-0000-000000000008', 4, CURRENT_DATE, 'active'),
  ('00000008-0000-0000-0000-000000000019', '00000003-0000-0000-0000-000000000020', '00000007-0000-0000-0000-000000000006', 4, CURRENT_DATE, 'active'),
  ('00000008-0000-0000-0000-00000000001a', '00000003-0000-0000-0000-000000000021', '00000007-0000-0000-0000-000000000009', 4, CURRENT_DATE, 'active'),
  ('00000008-0000-0000-0000-00000000001b', '00000003-0000-0000-0000-000000000022', '00000007-0000-0000-0000-000000000004', 5, CURRENT_DATE, 'active'),
  ('00000008-0000-0000-0000-00000000001c', '00000003-0000-0000-0000-000000000023', '00000007-0000-0000-0000-000000000005', 5, CURRENT_DATE, 'active'),
  ('00000008-0000-0000-0000-00000000001d', '00000003-0000-0000-0000-000000000024', '00000007-0000-0000-0000-000000000007', 5, CURRENT_DATE, 'active'),
  ('00000008-0000-0000-0000-00000000001e', '00000003-0000-0000-0000-000000000025', '00000007-0000-0000-0000-000000000008', 5, CURRENT_DATE, 'active'),
  ('00000008-0000-0000-0000-00000000001f', '00000003-0000-0000-0000-000000000026', '00000007-0000-0000-0000-000000000006', 5, CURRENT_DATE, 'active'),
  ('00000008-0000-0000-0000-000000000020', '00000003-0000-0000-0000-000000000027', '00000007-0000-0000-0000-000000000009', 5, CURRENT_DATE, 'active'),
  ('00000008-0000-0000-0000-000000000021', '00000003-0000-0000-0000-000000000028', '00000007-0000-0000-0000-000000000004', 6, CURRENT_DATE, 'active'),
  ('00000008-0000-0000-0000-000000000022', '00000003-0000-0000-0000-000000000029', '00000007-0000-0000-0000-000000000005', 6, CURRENT_DATE, 'active'),
  ('00000008-0000-0000-0000-000000000023', '00000003-0000-0000-0000-00000000002a', '00000007-0000-0000-0000-000000000007', 6, CURRENT_DATE, 'active'),
  ('00000008-0000-0000-0000-000000000024', '00000003-0000-0000-0000-00000000002b', '00000007-0000-0000-0000-000000000008', 6, CURRENT_DATE, 'active'),
  ('00000008-0000-0000-0000-000000000025', '00000003-0000-0000-0000-00000000002c', '00000007-0000-0000-0000-000000000006', 6, CURRENT_DATE, 'active'),
  ('00000008-0000-0000-0000-000000000026', '00000003-0000-0000-0000-00000000002d', '00000007-0000-0000-0000-000000000009', 6, CURRENT_DATE, 'active'),
  ('00000008-0000-0000-0000-000000000027', '00000003-0000-0000-0000-00000000002e', '00000007-0000-0000-0000-000000000004', 7, CURRENT_DATE, 'active'),
  ('00000008-0000-0000-0000-000000000028', '00000003-0000-0000-0000-00000000002f', '00000007-0000-0000-0000-000000000005', 7, CURRENT_DATE, 'active'),
  ('00000008-0000-0000-0000-000000000029', '00000003-0000-0000-0000-000000000030', '00000007-0000-0000-0000-000000000007', 7, CURRENT_DATE, 'active'),
  ('00000008-0000-0000-0000-00000000002a', '00000003-0000-0000-0000-000000000031', '00000007-0000-0000-0000-000000000008', 7, CURRENT_DATE, 'active'),
  ('00000008-0000-0000-0000-00000000002b', '00000003-0000-0000-0000-000000000032', '00000007-0000-0000-0000-000000000006', 7, CURRENT_DATE, 'active'),
  ('00000008-0000-0000-0000-00000000002c', '00000003-0000-0000-0000-000000000033', '00000007-0000-0000-0000-000000000009', 7, CURRENT_DATE, 'active'),
  ('00000008-0000-0000-0000-00000000002d', '00000003-0000-0000-0000-000000000034', '00000007-0000-0000-0000-000000000004', 8, CURRENT_DATE, 'active'),
  ('00000008-0000-0000-0000-00000000002e', '00000003-0000-0000-0000-000000000035', '00000007-0000-0000-0000-000000000005', 8, CURRENT_DATE, 'active'),
  ('00000008-0000-0000-0000-00000000002f', '00000003-0000-0000-0000-000000000036', '00000007-0000-0000-0000-000000000007', 8, CURRENT_DATE, 'active'),
  ('00000008-0000-0000-0000-000000000030', '00000003-0000-0000-0000-000000000037', '00000007-0000-0000-0000-000000000008', 8, CURRENT_DATE, 'active'),
  ('00000008-0000-0000-0000-000000000031', '00000003-0000-0000-0000-000000000038', '00000007-0000-0000-0000-000000000006', 8, CURRENT_DATE, 'active'),
  ('00000008-0000-0000-0000-000000000032', '00000003-0000-0000-0000-000000000039', '00000007-0000-0000-0000-000000000009', 8, CURRENT_DATE, 'active'),
  ('00000008-0000-0000-0000-000000000033', '00000003-0000-0000-0000-00000000003a', '00000007-0000-0000-0000-000000000004', 9, CURRENT_DATE, 'active'),
  ('00000008-0000-0000-0000-000000000034', '00000003-0000-0000-0000-00000000003b', '00000007-0000-0000-0000-000000000005', 9, CURRENT_DATE, 'active'),
  ('00000008-0000-0000-0000-000000000035', '00000003-0000-0000-0000-00000000003c', '00000007-0000-0000-0000-000000000007', 9, CURRENT_DATE, 'active'),
  ('00000008-0000-0000-0000-000000000036', '00000003-0000-0000-0000-00000000003d', '00000007-0000-0000-0000-000000000008', 9, CURRENT_DATE, 'active')
ON CONFLICT (id) DO NOTHING;
...
VALUES 
  ...
  ('0000000a-0000-0000-0000-000000000003', '00000007-0000-0000-0000-000000000004', '11 NM A - Python Group Alpha', 'Core Python syntax and algorithmic problem solving', '00000003-0000-0000-0000-000000000003', NOW()),
  ('0000000a-0000-0000-0000-000000000004', '00000007-0000-0000-0000-000000000004', '11 NM A - Python Group Beta', 'Data operations and procedural logic', '00000003-0000-0000-0000-000000000003', NOW()),
  ('0000000a-0000-0000-0000-000000000005', '00000007-0000-0000-0000-000000000005', '11 NM B - Byte Knights', 'Python control flow and looping challenges', '00000003-0000-0000-0000-000000000004', NOW()),
  ('0000000a-0000-0000-0000-000000000006', '00000007-0000-0000-0000-000000000005', '11 NM B - CodeCrafters', 'Mathematical modeling and logic builders', '00000003-0000-0000-0000-000000000004', NOW()),
  ('0000000a-0000-0000-0000-000000000007', '00000007-0000-0000-0000-000000000007', '12 NM A - Turing Titans', 'Advanced Python collections and dictionary structures', '00000003-0000-0000-0000-000000000003', NOW()),
  ('0000000a-0000-0000-0000-000000000008', '00000007-0000-0000-0000-000000000007', '12 NM A - Binary Beasts', 'Data structures, list comprehensions, and nested mapping', '00000003-0000-0000-0000-000000000003', NOW()),
  ('0000000a-0000-0000-0000-000000000009', '00000007-0000-0000-0000-000000000008', '12 NM B - Logic Legends', 'Set theory and tuple serialization in Python', '00000003-0000-0000-0000-000000000004', NOW()),
  ('0000000a-0000-0000-0000-00000000000a', '00000007-0000-0000-0000-000000000008', '12 NM B - Syntax Stars', 'Practical lab assessments and viva preparation', '00000003-0000-0000-0000-000000000004', NOW())
ON CONFLICT (id) DO NOTHING;
