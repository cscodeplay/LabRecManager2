...
const HtmlPreview = ({ url }) => {
    ...
    if (loading) {
        return (
            <div className="flex flex-col items-center justify-center w-full h-full min-h-[500px] bg-slate-50 rounded-lg border border-slate-200">
    ...
    if (error) {
        return (
            <div className="flex flex-col items-center justify-center w-full h-full min-h-[500px] bg-red-50 text-red-500 rounded-lg border border-red-200 p-6 text-center">
