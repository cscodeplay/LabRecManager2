...
export default function RecordingShareModal({
    isOpen,
    onClose,
    onShare,
    recordingId
    ...
    const handleStartSharing = () => {
        ...
        if (targetType === 'class') {
            targetsPayload.push({ type: 'class', id: selectedTargets[0] });
        } else {
            selectedTargets.forEach(id => {
                targetsPayload.push({ type: targetType, id });
            });
        }

        if (onShare) {
            onShare(targetsPayload);
        }
    };
            ...
            <div className="bg-white rounded-xl max-w-lg w-full max-h-[80vh] overflow-hidden flex flex-col shadow-2xl">
                    ...
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <p className="text-sm text-white/80">
                                Choose who can view your recording
                            </p>
                        </div>
                    </div>
                    <button
                ...
                <div className="p-4 border-t border-slate-200 flex justify-end gap-3">
                    ...
                    <button
                        ...
                        className="px-6 py-2 bg-gradient-to-r from-amber-500 to-orange-500 hover:from-amber-600 hover:to-orange-600 text-white rounded-lg font-medium shadow-lg shadow-orange-500/25 disabled:opacity-50 transition"
                    >
                        Share Recording
                    </button>
                </div>
