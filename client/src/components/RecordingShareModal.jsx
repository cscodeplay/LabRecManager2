                    ...
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <p className="text-sm text-white/80">
                                {isSharing ? 'Currently sharing live' : 'Choose who can view your recording'}
                            </p>
                        </div>
                    </div>
                    <button
                ...
                <div className="flex-1 overflow-auto p-4">
                    {isSharing ? (
                        ...
                        <div className="text-center py-8">
                            ...
                            <h3 className="text-xl font-semibold text-slate-900 mb-2">Recording is Shared!</h3>
                            <p className="text-slate-600 mb-4">
                                Sharing with: {currentTargets?.join(', ') || 'selected targets'}
                            </p>
                            <button
