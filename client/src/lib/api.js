...
export const classesAPI = {
    ...
    updateGroup: (classId, groupId, data) => api.put(`/classes/${classId}/groups/${groupId}`, data),
...
export const trainingAPI = {
    ...
    getUnitTheory: (unitId) => api.get(`/training/units/${unitId}/theory`),
    updateUnitTheory: (unitId, data) => api.put(`/training/units/${unitId}/theory`, data),
    completeUnitTheory: (unitId) => api.post(`/training/units/${unitId}/theory/complete`),
