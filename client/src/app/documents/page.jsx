                                ...
                                <div key={item.shareId} className="card p-4">
                                    ...
                                    <div className="flex gap-2">
                                        <button
                                            ...
                                            className="flex-1 flex items-center justify-center p-3 rounded-xl bg-blue-50 hover:bg-blue-100 text-blue-600 transition"
                                            title="Preview"
                                        >
                                        ...
                                        <button
                                            ...
                                            className="flex-1 flex items-center justify-center p-3 rounded-xl bg-green-50 hover:bg-green-100 text-green-600 transition disabled:opacity-50"
                                            title="Download"
                                        >
                                            ...
                                            <td className="py-4 px-4 text-right">
                                                <div className="flex items-center gap-2 justify-end">
                                                    ...
                                                    <button
                                                        onClick={() => handleDownload(item)}
                                                        disabled={downloading === item.shareId}
                                                        className="p-2 bg-green-50 hover:bg-green-100 text-green-600 rounded-xl transition disabled:opacity-50"
                                                        title="Download"
                                                    >
                                                        {downloading === item.shareId ? (
                                                            <div className="w-5 h-5 border-2 border-green-600 border-t-transparent rounded-full animate-spin" />
                        ...
                        <div className="p-4 border-b border-slate-200 dark:border-slate-700 flex items-center justify-between bg-white dark:bg-slate-800">
                            ...
                            <div className="flex items-center gap-2">
                                ...
                                <a
                                    ...
                                    target="_blank"
                                    rel="noopener noreferrer"
                                    className="p-2 rounded-xl bg-primary-50 hover:bg-primary-100 text-primary-600 transition"
                                    title="Download"
                                >
                                    <Download className="w-5 h-5" />
                                </a>
