                                ...
                                >
                                    <div className="flex gap-4">
                                        ...
                                        <div className="flex-1 min-w-0">
                                            ...
                                            {/* Actionable Join Meeting Button */}
                                            {isMeetingInvite && actionTarget && (
                                                <div className="mt-3 flex items-center gap-2">
                                                    <button
                                                        ...
                                                        className="px-4 py-2 bg-emerald-600 hover:bg-emerald-500 text-white font-bold rounded-xl text-xs flex items-center gap-2 shadow-md transition"
                                                    >
